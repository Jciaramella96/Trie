...
public class Trie {
	...
	public static TrieNode buildTrie(String[] allWords) {
	    ...
	    TrieNode root = new TrieNode(null, null, null);
	       ...
	       int tundra = -1, startIdx = -1, endIdx = -1, wordIdx = -1;
	       ...
	       for(int i = 1; i < allWords.length; i++) {
	           ...
	           while(ptr != null) {
	               ...
	               tundra = similarUntil(allWords[wordIdx].substring(startIdx, endIdx+1),
	           ...
	           if(ptr == null) {
	               ...
	               Indexes currWordNewIndexes = new Indexes(currentIndexes.wordIndex, (short)(tundra+1), currentIndexes.endIndex);
	               currentIndexes.endIndex = (short)tundra;
	           ...
	           tundra = startIdx = endIdx = wordIdx = -1;
	       }
	...
	public static ArrayList<TrieNode> completionList(TrieNode root,
		...
		// MODIFY IT AS NEEDED FOR YOUR IMPLEMENTATION
	     if(root==null){
	       ...
	       String tundra = allWords[ptr.substr.wordIndex];
	       String alpha = tundra.substring(0, ptr.substr.endIndex+1);
	       if(tundra.startsWith(prefix) || prefix.startsWith(alpha)){
